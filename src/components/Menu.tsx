...
const Menu = () => {
  ...
  return (
    <div className="shadow-[inset_0_6px_0_8px_#2463FF] h-[481px] w-[324px] md:w-[592px] md:h-[530px] rounded-[72px] relative border bg-gradient-to-b from-[#344ABA]/50 to-[#001479]/50">
      <div className="shadow-[inset_0_-8px_0_4px_#140E66]  flex flex-col items-center justify-center h-[481px] w-[324px] md:w-[592px] md:h-[530px] rounded-[72px] relative border bg-gradient-to-b from-[#344ABA]/50 to-[#001479]/50">
        ...
        <motion.button
          ...
          className="shadow-[inset_0px_-4px_0px_5px_#243041,inset_0px_-12px_0px_11px_#9D2DF5] md:w-[200px] md:h-[200px] w-[160px] h-[160px] flex items-center justify-center cursor-pointer rounded-full mt-30 bg-gradient-to-b from-[#FE71FE] to-[#7199FF]"
        >
